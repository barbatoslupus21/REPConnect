...
def download_employee_template(request):
    ...
    dept_range = f"=ValidationData!$A$1:${get_column_letter(len(departments))}$1"
    ...
    line_range = f"=ValidationData!$A$2:${get_column_letter(len(lines))}$2"
    ...
    pos_range = f"=ValidationData!$A$3:${get_column_letter(len(positions))}$3"
    ...
    emp_range = f"=ValidationData!$A$4:${get_column_letter(len(employment_types))}$4"
