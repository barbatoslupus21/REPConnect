...
def get_ticket_details(request, ticket_id):
    ...
    data = {
        ...
        'requestor_department': ticket.requestor.employment_info.department.department_name if ticket.requestor else '',
        'device': ticket.device.device_name if ticket.device else '',
        'device_id': ticket.device.id if ticket.device else '',
        'device_model': ticket.device.device_model if ticket.device else '',
        'device_brand': ticket.device.device_brand if ticket.device else '',
